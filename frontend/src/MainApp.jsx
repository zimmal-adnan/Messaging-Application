...
function MainApp({username}){
    ...
    (msg.sender === targetUser && msg.recipient === username) || //message sent by friend to the user
    (msg.sender === username && msg.recipient === targetUser)  //message sent by user to friend
    );
